...
public sealed class FeatureLayerClientTimeReferenceUnknownQueryTests
{
    [Fact]
    public async Task QueryAsync_IncludesTimeReferenceUnknownClient_WhenProvided() {
    ...
    [Fact]
    public async Task QueryCountAsync_IncludesTimeReferenceUnknownClient_WhenProvided() {
        var cancellationToken = TestContext.Current.CancellationToken;
        var requestUris = new List<string>();
    ...
    [Fact]
    public async Task QueryObjectIdsAsync_IncludesTimeReferenceUnknownClient_WhenProvided() {
        var cancellationToken = TestContext.Current.CancellationToken;
        var requestUris = new List<string>();
    ...
    [Fact]
    public async Task QueryExtentAsync_IncludesTimeReferenceUnknownClient_WhenProvided() {
        var cancellationToken = TestContext.Current.CancellationToken;
        var requestUris = new List<string>();
