...
public sealed class FeatureLayerClientCalculateAsyncTests
{
    ...
    [Fact]
    public async Task SubmitCalculateAsync_ThrowsFeatureServiceException_WhenStatusUrlIsInvalid() {
        var cancellationToken = TestContext.Current.CancellationToken;
    ...
    [Fact]
    public async Task SubmitCalculateAsync_ThrowsFeatureServiceException_WhenStatusUrlIsNotAString() {
        var cancellationToken = TestContext.Current.CancellationToken;
