...
namespace S100FC.S123
{
	...
	public class Summary : ISummary
	{
		...
		public static definitionReference[] definitionReferenceFeatureTypes => [
			...
			new definitionReference(430, "IHOREG", "GMDSSArea", "GMDSS Area"),
			new definitionReference(453, "IHOREG", "IndeterminateZone", "Indeterminate Zone"),
			new definitionReference(572, "IHOREG", "RadioServiceArea", "Radio Service Area"),
			new definitionReference(717, "IHOREG", "RadioStation", "Radio Station"),
			new definitionReference(544, "IHOREG", "WeatherForecastAndWarningArea", "Weather Forecast and Warning Area"),
			new definitionReference(427, "IHOREG", "FuzzyAreaAggregate", "Fuzzy Area Aggregate"),
			new definitionReference(573, "IHOREG", "RadioServiceAreaAggregate", "Radio Service Area Aggregate"),
