...
namespace S100FC.S123.InformationAssociation
{
	...
	/// </summary>
	public class AvailableQoS : S100FC.association
	{
		public static string role => "theQoS";
		public AvailableQoS() {
			base.S100FC_code = nameof(AvailableQoS);
			base.S100FC_name = "Available Quality of Service";
		}
	...
	/// </summary>
	public class BroadcastService : S100FC.association
	{
		public static string role => "theBroadcastDetails";
		public BroadcastService() {
			base.S100FC_code = nameof(BroadcastService);
			base.S100FC_name = "Broadcast Service";
		}
	...
	/// </summary>
	public class BroadcastTransmission : S100FC.association
	{
		public static string role => "theTransmissionDetails";
		public BroadcastTransmission() {
			base.S100FC_code = nameof(BroadcastTransmission);
			base.S100FC_name = "Broadcast Transmission";
		}
	...
	/// </summary>
	public class ConnectivityService : S100FC.association
	{
		public static string role => "connectivityServiceProvider";
		public ConnectivityService() {
			base.S100FC_code = nameof(ConnectivityService);
			base.S100FC_name = "Connectivity Service";
		}
	...
	/// </summary>
	public class RadioServiceControl : S100FC.association
	{
		public static string role => "theControlCentre";
		public RadioServiceControl() {
			base.S100FC_code = nameof(RadioServiceControl);
			base.S100FC_name = "Radio Service Control";
		}
	...
	/// </summary>
	public class ServiceCoordination : S100FC.association
	{
		public static string role => "coordinatingAuthority";
		public ServiceCoordination() {
			base.S100FC_code = nameof(ServiceCoordination);
			base.S100FC_name = "Service Coordination";
		}
	...
	/// </summary>
	public class TMAS : S100FC.association
	{
		public static string role => "theTMAS";
		public TMAS() {
			base.S100FC_code = nameof(TMAS);
			base.S100FC_name = "Available Telemedical Assistance Service";
		}
	...
	/// </summary>
	public class TransmissionService : S100FC.association
	{
		public static string role => "theTransmissionDetails";
		public TransmissionService() {
			base.S100FC_code = nameof(TransmissionService);
			base.S100FC_name = "Transmission Service";
		}
...
namespace S100FC.S123.FeatureAssociation
{
	...
	/// </summary>
	public class coreAggregation : S100FC.association
	{
		public static string[] roles => ["theCollection","theComponent"];
		public coreAggregation() {
			base.S100FC_code = nameof(coreAggregation);
			base.S100FC_name = "Core aggregation";
		}
	...
	/// </summary>
	public class fuzzyZoneAggregation : S100FC.association
	{
		public static string[] roles => ["theCollection","theComponent"];
		public fuzzyZoneAggregation() {
			base.S100FC_code = nameof(fuzzyZoneAggregation);
			base.S100FC_name = "Fuzzy zone aggregation";
		}
...
namespace S100FC.S123
{
	...
	public class Summary : ISummary
	{
		...
		public static definitionReference[] definitionReferences => [
			...
			new definitionReference(1148, "IHOREG", "Call Sign"),
			new definitionReference(1150, "IHOREG", "Contact Instructions"),
			new definitionReference(398, "IHOREG", "Category of Authority"),
			new definitionReference(400, "IHOREG", "Category of Broadcast/Communication"),
			...
			new definitionReference(407, "IHOREG", "Category of Forecast or Warning Area"),
			new definitionReference(409, "IHOREG", "Category of GMDSS Area"),
			...
			new definitionReference(1175, "IHOREG", "Coast Station Identification Code"),
			new definitionReference(1149, "IHOREG", "Communication Channel"),
			...
			new definitionReference(1151, "IHOREG", "Date Variable"),
			...
			new definitionReference(1159, "IHOREG", "Frequency Shore Station Receives"),
			new definitionReference(1160, "IHOREG", "Frequency Shore Station Transmits"),
			...
			new definitionReference(527, "IHOREG", "Information Confidence"),
			new definitionReference(1134, "IHOREG", "Interoperability Identifier"),
			new definitionReference(118, "IHOREG", "Is MRCC"),
			new definitionReference(1169, "IHOREG", "Language"),
			new definitionReference(540, "IHOREG", "Language Information"),
			new definitionReference(1146, "IHOREG", "Linkage"),
			...
			new definitionReference(945, "IHOREG", "Minute Past Even Hours"),
			new definitionReference(946, "IHOREG", "Minute Past Every Hour"),
			new definitionReference(947, "IHOREG", "Minute Past Odd Hours"),
			new definitionReference(1175, "IHOREG", "MMSI Code"),
			new definitionReference(1176, "IHOREG", "Name"),
			new definitionReference(1177, "IHOREG", "Name of Resource"),
			new definitionReference(1143, "IHOREG", "Name Usage"),
			new definitionReference(1178, "IHOREG", "Nationality"),
			new definitionReference(576, "IHOREG", "Observation Time"),
			...
			new definitionReference(1187, "IHOREG", "Sector Bearing"),
			new definitionReference(1188, "IHOREG", "Sector Line Length"),
			new definitionReference(961, "IHOREG", "Selective Call Number"),
			...
			new definitionReference(1199, "IHOREG", "Telecommunication Identifier"),
			...
			new definitionReference(681, "IHOREG", "Transmission Content"),
			new definitionReference(687, "IHOREG", "Transmitter Identification Character"),
			new definitionReference(682, "IHOREG", "Transmission of Traffic Lists"),
			new definitionReference(883, "IHOREG", "Transmission Power"),
			new definitionReference(684, "IHOREG", "Transmission Regularity"),
			new definitionReference(685, "IHOREG", "Transmission Time"),
