...
namespace S100FC.S123
{
	...
	public class Summary : ISummary
	{
		...
		public static definitionReference[] definitionReferenceFeatureTypes => [
			...
			new definitionReference(430, "IHOREG", "GMDSSArea", "GMDSS Area", [Primitives.surface]),
			new definitionReference(453, "IHOREG", "IndeterminateZone", "Indeterminate Zone", [Primitives.surface]),
			new definitionReference(572, "IHOREG", "RadioServiceArea", "Radio Service Area", [Primitives.surface]),
			new definitionReference(717, "IHOREG", "RadioStation", "Radio Station", [Primitives.point]),
			new definitionReference(544, "IHOREG", "WeatherForecastAndWarningArea", "Weather Forecast and Warning Area", [Primitives.surface]),
			new definitionReference(427, "IHOREG", "FuzzyAreaAggregate", "Fuzzy Area Aggregate", [Primitives.noGeometry]),
			new definitionReference(573, "IHOREG", "RadioServiceAreaAggregate", "Radio Service Area Aggregate", [Primitives.noGeometry]),
			new definitionReference(661, "IHOREG", "DataCoverage", "Data Coverage", [Primitives.surface]),
