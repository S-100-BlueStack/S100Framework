...
namespace S100FC.S124.SimpleAttributes
{
	...
	public class year : S100FC.IntegerAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1076;
	...
	public class warningNumber : S100FC.IntegerAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1075;
	...
	public class nameOfSeries : S100FC.TextAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1073;
	...
	public class agencyResponsibleForProduction : S100FC.TextAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 387;
	...
	public class localityIdentifier : S100FC.UrnAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1077;
	...
	public class lastNoticeDate : S100FC.DateAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1068;
	...
	public class editionDate : S100FC.DateAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1067;
	...
	public class chartPlanNumber : S100FC.TextAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1066;
	...
	public class chartNumber : S100FC.TextAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1065;
	...
	public class publicationAffected : S100FC.TextAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1071;
	...
	public class internationalChartAffected : S100FC.TextAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1070;
	...
	public class chartPublicationIdentifier : S100FC.UrnAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1069;
	...
	public class intService : S100FC.BooleanAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1095;
	...
	public class cancellationDate : S100FC.DateTimeAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1094;
	...
	public class noMessageOnHand : S100FC.BooleanAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1093;
	...
	public class publicationTime : S100FC.DateTimeAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1096;
	...
	public class navwarnTypeDetails : S100FC.CodeListAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1102;
	...
	public class navwarnTypeGeneral : S100FC.CodeListAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1008;
		public static listedValue[] listedValues => [
...
namespace S100FC.S124.ComplexAttributes
{
	...
	public class chartAffected : S100FC.ComplexAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1086;
	...
	public class locationName : S100FC.ComplexAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1088;
	...
	public class messageSeriesIdentifier : S100FC.ComplexAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1087;
	...
	public class navwarnTitle : S100FC.ComplexAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1089;
	...
	public class warningInformation : S100FC.ComplexAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1091;
	...
	public class affectedChartPublications : S100FC.ComplexAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1097;
	...
	public class generalArea : S100FC.ComplexAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1098;
	...
	public class locality : S100FC.ComplexAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 1099;
...
namespace S100FC.S124.FeatureTypes
{
	...
	public class NavwarnPart : S100FC.FeatureType, IInformationBindings, IFeatureBindings
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 620;
	...
	public class NavwarnAreaAffected : S100FC.FeatureType, IInformationBindings, IFeatureBindings
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => 641;
...
namespace S100FC.S124
{
	...
	public class Summary : ISummary
	{
		...
		public static definitionReference[] definitionReferences => [
			...
			new definitionReference(1076, "IHOREG", "Year"),
			new definitionReference(1006, "IHOREG", "Warning Type"),
			new definitionReference(1075, "IHOREG", "Warning Number"),
			new definitionReference(1073, "IHOREG", "Name of Series"),
			new definitionReference(1178, "IHOREG", "Nationality"),
			new definitionReference(387, "IHOREG", "Agency Responsible for Production"),
			...
			new definitionReference(1077, "IHOREG", "Locality Identifier"),
			...
			new definitionReference(1068, "IHOREG", "Last Notice Date"),
			new definitionReference(1067, "IHOREG", "Edition Date"),
			new definitionReference(1066, "IHOREG", "Chart Plan Number"),
			new definitionReference(1065, "IHOREG", "Chart Number"),
			new definitionReference(1071, "IHOREG", "Publication Affected"),
			new definitionReference(1070, "IHOREG", "International Chart Affected"),
			new definitionReference(1069, "IHOREG", "Chart Publication Identifier"),
			new definitionReference(1095, "IHOREG", "Int Service"),
			new definitionReference(1094, "IHOREG", "Cancellation Date"),
			new definitionReference(1007, "IHOREG", "Reference Category"),
			new definitionReference(1093, "IHOREG", "No Message On Hand"),
			...
			new definitionReference(1096, "IHOREG", "Publication Time"),
			new definitionReference(1102, "IHOREG", "Navwarn Type Details"),
			new definitionReference(1008, "IHOREG", "Navwarn Type General"),
