...
namespace S100FC.S131
{
	...
	public class Summary : ISummary
	{
		...
		public static definitionReference[] definitionReferences => [
			...
			new definitionReference(1024, "IHOREG", "Applicable Load Line Zone"),
			new definitionReference(389, "IHOREG", "Application Profile"),
			new definitionReference(1025, "IHOREG", "Approach Description"),
			new definitionReference(1026, "IHOREG", "Associated Feature Name"),
			new definitionReference(1027, "IHOREG", "Available Berthing Length"),
			new definitionReference(1028, "IHOREG", "Berthing Assistance"),
			new definitionReference(1029, "IHOREG", "Bollard Description"),
			new definitionReference(1023, "IHOREG", "Bollard Number"),
			...
			new definitionReference(1031, "IHOREG", "Cargo Service"),
			new definitionReference(6, "IHOREG", "Category of Anchorage"),
			new definitionReference(398, "IHOREG", "Category of Authority"),
			new definitionReference(1058, "IHOREG", "Category of Berth Location"),
			...
			new definitionReference(1034, "IHOREG", "Category of Depths Description"),
			new definitionReference(1142, "IHOREG", "Category of Dolphin"),
			new definitionReference(310, "IHOREG", "Category of Frequency"),
			new definitionReference(26, "IHOREG", "Category of Harbour Facility"),
			new definitionReference(38, "IHOREG", "Category of Mooring/Warping Facility"),
			new definitionReference(1032, "IHOREG", "Category of Port Section"),
			new definitionReference(422, "IHOREG", "Category of Relationship"),
			new definitionReference(57, "IHOREG", "Category of Schedule"),
			new definitionReference(1328, "IHOREG", "Category of Shore Power Facility"),
			...
			new definitionReference(327, "IHOREG", "Category of Voltage"),
			new definitionReference(1035, "IHOREG", "Cathodic Protection System"),
			...
			new definitionReference(1154, "IHOREG", "Destination"),
			new definitionReference(1002, "IHOREG", "Development"),
			new definitionReference(812, "IHOREG", "Distance"),
			new definitionReference(471, "IHOREG", "Dynamic Resource"),
			new definitionReference(826, "IHOREG", "Elevation"),
			new definitionReference(1036, "IHOREG", "Entrance Description"),
			new definitionReference(101, "IHOREG", "File Locator"),
			new definitionReference(102, "IHOREG", "File Reference"),
			new definitionReference(1037, "IHOREG", "Firefighting Service"),
			...
			new definitionReference(1022, "IHOREG", "GLN Extension"),
			new definitionReference(997, "IHOREG", "Global Location Number"),
			new definitionReference(108, "IHOREG", "Headline"),
			new definitionReference(1038, "IHOREG", "Heaving Lines From Shore"),
			new definitionReference(1162, "IHOREG", "Height"),
			new definitionReference(837, "IHOREG", "Horizontal Distance Uncertainty"),
			new definitionReference(522, "IHOREG", "ID Code"),
			...
			new definitionReference(1062, "IHOREG", "Local Knowledge Description"),
			new definitionReference(545, "IHOREG", "Location by Text"),
			new definitionReference(546, "IHOREG", "Location Maritime Resource Name"),
			new definitionReference(547, "IHOREG", "Logical Connectives"),
			new definitionReference(1020, "IHOREG", "Manifold Number"),
			new definitionReference(936, "IHOREG", "Maximum Display Scale"),
			new definitionReference(1172, "IHOREG", "Maximum Permitted Draught"),
			new definitionReference(1173, "IHOREG", "Maximum Permitted Vessel Length"),
			new definitionReference(1039, "IHOREG", "Medical Service"),
			new definitionReference(556, "IHOREG", "Membership"),
			new definitionReference(1040, "IHOREG", "Method of Securing"),
			new definitionReference(1021, "IHOREG", "Metre Mark Number"),
			new definitionReference(1019, "IHOREG", "Minimum Berth Depth"),
			...
			new definitionReference(1018, "IHOREG", "Port Facility Number"),
			new definitionReference(602, "IHOREG", "Postal Code"),
			new definitionReference(144, "IHOREG", "Product"),
			...
			new definitionReference(1183, "IHOREG", "Radius"),
			new definitionReference(1017, "IHOREG", "Ramp Number"),
			new definitionReference(1041, "IHOREG", "Repair Service"),
			new definitionReference(154, "IHOREG", "Reported Date"),
			new definitionReference(958, "IHOREG", "Scale Minimum"),
			new definitionReference(1042, "IHOREG", "Ship Sanitation Control"),
			new definitionReference(1329, "IHOREG", "Shore Power Description"),
			new definitionReference(1331, "IHOREG", "Shore Power Service Provider"),
			new definitionReference(992, "IHOREG", "Sill Depth"),
			new definitionReference(1016, "IHOREG", "SMDG Terminal Code"),
			...
			new definitionReference(1043, "IHOREG", "Supply Service"),
			new definitionReference(1014, "IHOREG", "Technical Port Service"),
			...
			new definitionReference(1044, "IHOREG", "Terminal Identifier"),
			...
			new definitionReference(1012, "IHOREG", "Tug Information"),
			new definitionReference(370, "IHOREG", "UN Location Code"),
			new definitionReference(885, "IHOREG", "Uncertainty Fixed"),
			new definitionReference(886, "IHOREG", "Uncertainty Variable Factor"),
			new definitionReference(905, "IHOREG", "Vertical Clearance Value"),
			...
			new definitionReference(1121, "IHOREG", "Visitors Mooring"),
			new definitionReference(1011, "IHOREG", "Waste Disposal Service"),
			...
			new definitionReference(1033, "IHOREG", "Security-Safety-Emergency Service"),
			new definitionReference(1015, "IHOREG", "Transport Connection"),
		];
	}
