...
namespace S100FC.S122.SimpleAttributes
{
	...
	public class designationIdentifier : S100FC.TextAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => designationIdentifier._sourceIdentifier;
	...
	public class designationScheme : S100FC.TextAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => designationScheme._sourceIdentifier;
		public const int _sourceIdentifier = 0;
	...
	public class jurisdiction : S100FC.EnumerationAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => jurisdiction._sourceIdentifier;
		public const int _sourceIdentifier = 119;
		public jurisdiction() {}
		[JsonIgnore]
		public override listedValue[] listedValues => [
...
namespace S100FC.S122.ComplexAttributes
{
	...
	public class designation : S100FC.ComplexAttribute
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => designation._sourceIdentifier;
		public const int _sourceIdentifier = 0;
...
namespace S100FC.S122.FeatureTypes
{
	...
	public class InformationArea : FeatureType
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => InformationArea._sourceIdentifier;
		public const int _sourceIdentifier = 315;
	...
	public class MarineProtectedArea : FeatureType
	{
		...
		[JsonIgnore]
		public override int sourceIdentifier => MarineProtectedArea._sourceIdentifier;
		public const int _sourceIdentifier = 586;
...
namespace S100FC.S122
{
	...
	public class Summary : ISummary
	{
		...
		public static definitionReference[] definitionReferenceFeatureTypes => [
			...
			new definitionReference(315, "IHOREG", "InformationArea", "Information Area", [Primitives.surface]),
			new definitionReference(586, "IHOREG", "MarineProtectedArea", "Marine Protected Area", [Primitives.curve,Primitives.surface]),
