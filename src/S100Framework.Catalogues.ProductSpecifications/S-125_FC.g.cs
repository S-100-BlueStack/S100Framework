...
namespace S100FC.S125
{
	...
	public class Summary : ISummary
	{
		...
		public static definitionReference[] definitionReferenceFeatureTypes => [
			new definitionReference(549, "IHOREG", "AidsToNavigation", "Aids to Navigation"),
			new definitionReference(421, "IHOREG", "Equipment", "Equipment"),
			new definitionReference(577, "IHOREG", "StructureObject", "Structure Object"),
			new definitionReference(559, "IHOREG", "GenericBuoy", "Generic Buoy"),
			new definitionReference(558, "IHOREG", "GenericBeacon", "Generic Beacon"),
			new definitionReference(665, "IHOREG", "NavigationLine", "Navigation Line"),
			new definitionReference(666, "IHOREG", "RecommendedTrack", "Recommended Track"),
			new definitionReference(226, "IHOREG", "Landmark", "Landmark"),
			new definitionReference(709, "IHOREG", "Daymark", "Daymark"),
			new definitionReference(714, "IHOREG", "FogSignal", "Fog Signal"),
			new definitionReference(713, "IHOREG", "RadarReflector", "Radar Reflector"),
			new definitionReference(718, "IHOREG", "RadarTransponderBeacon", "Radar Transponder Beacon"),
			new definitionReference(717, "IHOREG", "RadioStation", "Radio Station"),
			new definitionReference(712, "IHOREG", "Retroreflector", "Retroreflector"),
			new definitionReference(696, "IHOREG", "LightAirObstruction", "Light Air Obstruction"),
			new definitionReference(693, "IHOREG", "LightAllAround", "Light All Around"),
			new definitionReference(695, "IHOREG", "LightFogDetector", "Light Fog Detector"),
			new definitionReference(694, "IHOREG", "LightSectored", "Light Sectored"),
			new definitionReference(710, "IHOREG", "LightFloat", "Light Float"),
			new definitionReference(711, "IHOREG", "LightVessel", "Light Vessel"),
			new definitionReference(656, "IHOREG", "OffshorePlatform", "Offshore Platform"),
			new definitionReference(233, "IHOREG", "Pile", "Pile"),
			new definitionReference(227, "IHOREG", "SiloTank", "Silo/Tank"),
			new definitionReference(698, "IHOREG", "CardinalBuoy", "Cardinal Buoy"),
			new definitionReference(702, "IHOREG", "EmergencyWreckMarkingBuoy", "Emergency Wreck Marking Buoy"),
			new definitionReference(703, "IHOREG", "InstallationBuoy", "Installation Buoy"),
			new definitionReference(699, "IHOREG", "IsolatedDangerBuoy", "Isolated Danger Buoy"),
			new definitionReference(697, "IHOREG", "LateralBuoy", "Lateral Buoy"),
			new definitionReference(660, "IHOREG", "MooringBuoy", "Mooring Buoy"),
			new definitionReference(700, "IHOREG", "SafeWaterBuoy", "Safe Water Buoy"),
			new definitionReference(701, "IHOREG", "SpecialPurposeGeneralBuoy", "Special Purpose/General Buoy"),
			new definitionReference(705, "IHOREG", "CardinalBeacon", "Cardinal Beacon"),
			new definitionReference(706, "IHOREG", "IsolatedDangerBeacon", "Isolated Danger Beacon"),
			new definitionReference(707, "IHOREG", "SafeWaterBeacon", "Safe Water Beacon"),
			new definitionReference(708, "IHOREG", "SpecialPurposeGeneralBeacon", "Special Purpose/General Beacon"),
			new definitionReference(704, "IHOREG", "LateralBeacon", "Lateral Beacon"),
			new definitionReference(228, "IHOREG", "WindTurbine", "Wind Turbine"),
			new definitionReference(598, "IHOREG", "VerticalDatumOfData", "Vertical Datum of Data"),
			new definitionReference(661, "IHOREG", "DataCoverage", "Data Coverage"),
			new definitionReference(189, "IHOREG", "LocalDirectionOfBuoyage", "Local Direction of Buoyage"),
			new definitionReference(188, "IHOREG", "NavigationalSystemOfMarks", "Navigational System of Marks"),
			new definitionReference(191, "IHOREG", "SoundingDatum", "Sounding Datum"),
			new definitionReference(643, "IHOREG", "QualityOfBathymetricData", "Quality of Bathymetric Data"),
			new definitionReference(715, "IHOREG", "PhysicalAISAidToNavigation", "Physical AIS Aid to Navigation"),
			new definitionReference(358, "IHOREG", "VirtualAISAidToNavigation", "Virtual AIS Aid to Navigation"),
		];
	}
