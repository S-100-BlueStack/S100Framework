...
namespace S100FC.S125
{
	...
	public class Summary : ISummary
	{
		...
		public static definitionReference[] definitionReferences => [
			new definitionReference(1157, "IHOREG", "File Locator"),
			new definitionReference(1231, "IHOREG", "Uncertainty Fixed"),
			new definitionReference(1232, "IHOREG", "Uncertainty Variable Factor"),
			new definitionReference(983, "IHOREG", "Virtual AIS Aid to Navigation Type"),
			new definitionReference(132, "IHOREG", "Moire Effect"),
			new definitionReference(860, "IHOREG", "Orientation Value"),
			new definitionReference(164, "IHOREG", "Signal Status"),
			new definitionReference(792, "IHOREG", "Date Start"),
			new definitionReference(790, "IHOREG", "Date End"),
			new definitionReference(1200, "IHOREG", "Text"),
			new definitionReference(1161, "IHOREG", "Headline"),
			new definitionReference(960, "IHOREG", "Sector Line Length"),
			new definitionReference(867, "IHOREG", "Signal Duration"),
			new definitionReference(866, "IHOREG", "Sector Bearing"),
			new definitionReference(912, "IHOREG", "Wave Length Value"),
			new definitionReference(146, "IHOREG", "Radar Band"),
			new definitionReference(951, "IHOREG", "Number of Features"),
			new definitionReference(133, "IHOREG", "Multiplicity Known"),
			new definitionReference(991, "IHOREG", "Sector Arc Extension"),
			new definitionReference(1158, "IHOREG", "File Reference"),
			new definitionReference(131, "IHOREG", "MMSI Code"),
			new definitionReference(122, "IHOREG", "Light Characteristic"),
			new definitionReference(1134, "IHOREG", "Interoperability Identifier"),
			new definitionReference(134, "IHOREG", "Name"),
			new definitionReference(1186, "IHOREG", "Scale Minimum"),
			new definitionReference(288, "IHOREG", "Source Date"),
			new definitionReference(1228, "IHOREG", "Source"),
			new definitionReference(1181, "IHOREG", "Pictorial Representation"),
			new definitionReference(530, "IHOREG", "Installation Date"),
			new definitionReference(39, "IHOREG", "Category of Navigation Line"),
			new definitionReference(1, "IHOREG", "Based On Fixed Marks"),
			new definitionReference(1153, "IHOREG", "Depth Range Minimum Value"),
			new definitionReference(848, "IHOREG", "Maximal Permitted Draught"),
			new definitionReference(145, "IHOREG", "Quality of Vertical Measurement"),
			new definitionReference(725, "IHOREG", "Status"),
			new definitionReference(1138, "IHOREG", "Technique of Vertical Measurement"),
			new definitionReference(184, "IHOREG", "Traffic Flow"),
			new definitionReference(996, "IHOREG", "Vertical Datum"),
			new definitionReference(1072, "IHOREG", "AtoN Number"),
			new definitionReference(3, "IHOREG", "Buoy Shape"),
			new definitionReference(72, "IHOREG", "Colour"),
			new definitionReference(73, "IHOREG", "Colour Pattern"),
			new definitionReference(147, "IHOREG", "Radar Conspicuous"),
			new definitionReference(1238, "IHOREG", "Marks Navigational - System Of"),
			new definitionReference(137, "IHOREG", "Nature of Construction"),
			new definitionReference(690, "IHOREG", "Type of Buoy"),
			new definitionReference(2, "IHOREG", "Beacon Shape"),
			new definitionReference(201, "IHOREG", "Visual Prominence"),
			new definitionReference(1162, "IHOREG", "Height"),
			new definitionReference(1212, "IHOREG", "Vertical Length"),
			new definitionReference(987, "IHOREG", "Category of Landmark"),
			new definitionReference(107, "IHOREG", "Function"),
			new definitionReference(92, "IHOREG", "Category of Special Purpose Mark"),
			new definitionReference(202, "IHOREG", "Topmark/Daymark Shape"),
			new definitionReference(23, "IHOREG", "Category of Fog Signal"),
			new definitionReference(51, "IHOREG", "Category of Radar Transponder Beacon"),
			new definitionReference(1191, "IHOREG", "Signal Group"),
			new definitionReference(1192, "IHOREG", "Signal Period"),
			new definitionReference(1209, "IHOREG", "Value of Nominal Range"),
			new definitionReference(52, "IHOREG", "Category of Radio Station"),
			new definitionReference(1156, "IHOREG", "Estimated Range of Transmission"),
			new definitionReference(123, "IHOREG", "Light Visibility"),
			new definitionReference(99, "IHOREG", "Exhibition Condition of Light"),
			new definitionReference(922, "IHOREG", "Flare Bearing"),
			new definitionReference(161, "IHOREG", "Signal Generation"),
			new definitionReference(127, "IHOREG", "Major Light"),
			new definitionReference(88, "IHOREG", "Category of Light"),
			new definitionReference(41, "IHOREG", "Category of Offshore Platform"),
			new definitionReference(75, "IHOREG", "Condition"),
			new definitionReference(44, "IHOREG", "Category of Pile"),
			new definitionReference(79, "IHOREG", "Building Shape"),
			new definitionReference(62, "IHOREG", "Category of Silo/Tank"),
			new definitionReference(34, "IHOREG", "Category of Lateral Mark"),
			new definitionReference(11, "IHOREG", "Category of Cardinal Mark"),
			new definitionReference(1155, "IHOREG", "Elevation"),
			new definitionReference(1237, "IHOREG", "Maximum Display Scale"),
			new definitionReference(1222, "IHOREG", "Minimum Display Scale"),
			new definitionReference(200, "IHOREG", "Category of Temporal Variation"),
			new definitionReference(1224, "IHOREG", "Orientation Uncertainty"),
			new definitionReference(1216, "IHOREG", "Horizontal Distance Uncertainty"),
		];
	}
