...
namespace S100FC.S127
{
	...
	public class Summary : ISummary
	{
		...
		public static definitionReference[] definitionReferenceFeatureTypes => [
			...
			new definitionReference(503, "IHOREG", "ReportableServiceArea", "Reportable Service Area"),
			new definitionReference(314, "IHOREG", "CautionArea", "Caution Area"),
			new definitionReference(412, "IHOREG", "ConcentrationOfShippingHazardArea", "Concentration of Shipping Hazard Area"),
			new definitionReference(458, "IHOREG", "ISPSCodeSecurityLevel", "ISPS Code Security Level"),
			new definitionReference(311, "IHOREG", "MilitaryPracticeArea", "Military Practice Area"),
			new definitionReference(361, "IHOREG", "PilotBoardingPlace", "Pilot Boarding Place"),
			new definitionReference(570, "IHOREG", "PilotService", "Pilot Service"),
			new definitionReference(326, "IHOREG", "PilotageDistrict", "Pilotage District"),
			new definitionReference(491, "IHOREG", "PiracyRiskArea", "Piracy Risk Area"),
			new definitionReference(492, "IHOREG", "PlaceOfRefuge", "Place of Refuge"),
			new definitionReference(305, "IHOREG", "RadarRange", "Radar Range"),
			new definitionReference(303, "IHOREG", "RadioCallingInPoint", "Radio Calling-In Point"),
			new definitionReference(375, "IHOREG", "RestrictedArea", "Restricted Area"),
			new definitionReference(506, "IHOREG", "RouteingMeasure", "Routeing Measure"),
			new definitionReference(364, "IHOREG", "SignalStationWarning", "Signal Station Warning"),
			new definitionReference(365, "IHOREG", "SignalStationTraffic", "Signal Station Traffic"),
			new definitionReference(537, "IHOREG", "UnderKeelClearanceAllowanceArea", "Under Keel Clearance Allowance Area"),
			new definitionReference(540, "IHOREG", "UnderKeelClearanceManagementArea", "Under Keel Clearance Management Area"),
			new definitionReference(362, "IHOREG", "VesselTrafficServiceArea", "Vessel Traffic Service Area"),
