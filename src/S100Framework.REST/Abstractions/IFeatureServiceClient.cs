...
public interface IFeatureServiceClient
{
    ...
    /// <summary>
    /// Sends an <c>extractChanges</c> request and waits for the server to return the final result payload.
    /// </summary>
    /// <param name="request">The <c>extractChanges</c> request.</param>
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The final result returned by the server.</returns>
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The downloaded file result.</returns>
