...
/// <summary>
/// Defines options for a state-aware bidirectional replica synchronization workflow.
/// </summary>
public sealed record SynchronizeReplicaStateBidirectionalRequest
{
    /// <summary>
    ...
    /// <summary>
    /// Validates the bidirectional synchronization options.
    /// </summary>
    ...
    public void Validate() {
        ...
        if (payloadCount == 0) {
            throw new InvalidOperationException(
                "Bidirectional replica synchronization requires Edits, EditsJson, or EditsUploadId.");
        }
