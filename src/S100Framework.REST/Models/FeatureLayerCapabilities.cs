...
/// Indicates whether the layer supports attachments.
/// </param>
/// <param name="SupportsQueryAttachments">
/// Indicates whether attachment query operations are supported.
/// </param>
/// <param name="SupportsAttachmentsResizing">
/// Indicates whether attachment resizing is supported.
/// </param>
/// <param name="SupportsTopFeaturesQuery">
/// Indicates whether top-features queries are supported.
/// </param>
/// <param name="SupportsPagination">
/// Indicates whether standard pagination is supported.
/// </param>
/// <param name="SupportsPaginationOnAggregatedQueries">
/// Indicates whether pagination is supported for aggregated queries.
/// </param>
/// <param name="SupportsQueryRelatedPagination">
/// Indicates whether pagination is supported for related-record queries.
/// </param>
/// <param name="SupportsAdvancedQueryRelated">
/// Indicates whether advanced related-record query functionality is supported.
/// </param>
/// <param name="SupportsOrderBy">
/// Indicates whether order-by clauses are supported.
/// </param>
/// <param name="SupportsDistinct">
/// Indicates whether distinct queries are supported.
/// </param>
