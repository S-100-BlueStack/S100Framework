...
/// <summary>
/// Represents the final result of a service-level <c>applyEdits</c> operation across multiple layers.
/// </summary>
/// <param name="LayerResults">The edit results grouped by layer.</param>
public sealed record FeatureServiceApplyEditsResult(
    IReadOnlyList<ServiceLayerEditResults> LayerResults);

/// <summary>
/// Represents the final <c>applyEdits</c> result for a single layer within a service-level request.
/// </summary>
/// <param name="LayerId">The layer ID that produced these results.</param>
